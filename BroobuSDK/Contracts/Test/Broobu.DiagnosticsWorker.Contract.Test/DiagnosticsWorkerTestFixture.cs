...
namespace Pms.DiagnosticsWorker.Contract.Test
{
    /// <summary>
    /// Summary description for UnitTest1
    /// </summary>
    [TestClass]
    public class DiagnosticsWorkerTestFixture 
    {
        public DiagnosticsWorkerTestFixture()
        {
            //
        ...
        {
            var r = DiagnosticsWorkerAgentFactory
